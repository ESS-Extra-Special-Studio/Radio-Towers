...
public class AirdropConfig {
    ...
    public static final ModConfigSpec.IntValue LOBBY_MAX_PLAYERS;
    public static final ModConfigSpec.IntValue LOBBY_COUNTDOWN_SECONDS;
    public static final ModConfigSpec.IntValue LOBBY_INVITE_TIMEOUT_SECONDS;
    public static final ModConfigSpec.BooleanValue LOBBY_MEMBERS_ONLY_CRATES;
