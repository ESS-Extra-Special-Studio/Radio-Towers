...
public class AirdropConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> WHITELIST_FILE;
    public static final ForgeConfigSpec.ConfigValue<String> BLACKLIST_FILE;
    public static final ForgeConfigSpec.IntValue DEFAULT_DIFFICULTY_PER_ITEM;
    public static final ForgeConfigSpec.ConfigValue<Integer> MINIMUM_CATALOG_POINTS;
    public static final ForgeConfigSpec.IntValue MAX_TOTAL_DIFFICULTY;
    public static final ForgeConfigSpec.BooleanValue INCLUDE_TACZ_AMMO;
    public static final ForgeConfigSpec.BooleanValue INCLUDE_TACZ_GUNS;
    public static final ForgeConfigSpec.BooleanValue SIMPLIFY_TACZ_ICONS_IN_AIRDROP_LIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CUSTOM_CATALOG_ENTRIES;
    public static final ForgeConfigSpec.ConfigValue<String> CUSTOM_CATALOG_FILE;
    public static final ForgeConfigSpec.BooleanValue INCLUDE_NON_VANILLA_FORGE_TAG_ITEMS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_END_RECIPE_ITEMS;

    // --- Standard airdrop (loot-table lever / empty order) ---
    public static final ForgeConfigSpec.ConfigValue<String> STANDARD_AIRDROP_LOOT_TABLE;
    public static final ForgeConfigSpec.BooleanValue ENABLE_STANDARD_AIRDROP;
    public static final ForgeConfigSpec.BooleanValue ENABLE_CATALOG_AIRDROP;
    public static final ForgeConfigSpec.ConfigValue<String> ACTIVE_AIRDROP_PROFILE;
    ...
    public static final ForgeConfigSpec.IntValue WAVE_DURATION_MINUTES;
    public static final ForgeConfigSpec.IntValue MAX_WAVES;
    public static final ForgeConfigSpec.IntValue BASE_ZOMBIES_PER_WAVE;
    public static final ForgeConfigSpec.IntValue ZOMBIES_PER_TIER_STEP;

    // --- Worldgen ---
    public static final ForgeConfigSpec.IntValue TOWER_SPAWN_DENSITY_PERCENT;
    public static final ForgeConfigSpec.BooleanValue GUARANTEE_SPAWN_TOWER;
    public static final ForgeConfigSpec.IntValue SPAWN_TOWER_SEARCH_RADIUS_CHUNKS;
